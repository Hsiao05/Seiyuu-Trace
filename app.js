...
function bind() {
  $('#uidImportBtn').addEventListener('click',importUid); $('#uidInput').addEventListener('keydown',e=>{if(e.key==='Enter')importUid();});
  $('#batchToggle').addEventListener('click',()=>$('#batchDialog').showModal()); $('#batchImportBtn').addEventListener('click',importIds);
